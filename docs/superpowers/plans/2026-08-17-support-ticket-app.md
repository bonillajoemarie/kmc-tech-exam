...
- **Subagent skills:** implementer agents must read these superpowers skill files first and follow them:
  - `/home/jmbonilla/.claude/plugins/cache/superpowers-marketplace/superpowers/6.2.0/skills/test-driven-development/SKILL.md` (backend + frontend)
  - `/home/jmbonilla/.claude/plugins/cache/superpowers-marketplace/superpowers/6.2.0/skills/verification-before-completion/SKILL.md` (all)
  - `/home/jmbonilla/.claude/plugins/cache/superpowers-marketplace/superpowers/6.2.0/skills/systematic-debugging/SKILL.md` (when debugging)
  - frontend agent additionally: `/home/jmbonilla/.claude/plugins/cache/superpowers-marketplace/superpowers/6.2.0/skills/frontend-design/SKILL.md` (if present; else claude-plugins-official frontend-design at `/home/jmbonilla/.claude/plugins/cache/claude-plugins-official/frontend-design/unknown`)
